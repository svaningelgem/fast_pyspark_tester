...
from fast_pyspark_tester.sql.casts import cast_to_string
from fast_pyspark_tester.sql.expressions.aggregate.aggregations import Aggregation
from fast_pyspark_tester.sql.expressions.mappers import StarOperator
from fast_pyspark_tester.sql.functions import col
from fast_pyspark_tester.sql.internal_utils.options import Options
from fast_pyspark_tester.sql.internal_utils.readwrite import to_option_stored_value
from fast_pyspark_tester.sql.utils import AnalysisException
from fast_pyspark_tester.utils import portable_hash, get_json_encoder
...
class WriteInFolder(Aggregation):
    """
    This use the computation engine of fast_pyspark_tester to write the values in a folder.
